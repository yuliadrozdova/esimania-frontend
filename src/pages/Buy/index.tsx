        ...
        <div className="d-grid grid-cols-1 gap-20 gap-sm-30 gap-lg-40 py-20 py-sm-30 py-lg-40">
                    ...
                    <ul className="esim-buy-header-info-list">
                      <li>
                        <div className="c--sim_item-row sim-item-row coverage light">
                          <span
                            className="icon-globe-2 list-icon sim-item-row-left-icon row-item-icon-padding"></span>
                      ...
                      <li>
                        <div className="c--sim_item-row sim-item-row light"><span
                            className="icon-arrows-up-and-down list-icon sim-item-row-left-icon row-item-icon-padding"></span>
                      ...
                      <li>
                        <div className="c--sim_item-row sim-item-row light"><span
                            className="icon-calendar list-icon sim-item-row-left-icon row-item-icon-padding"></span>
            ...
            <div className="choosing-wrapper d-grid grid-cols-1 grid-cols-sm-2 gap-30">
                ...
                <div className="c--checkout_choose-box choose-box-wrapper flex flex-column h-100">
                  ...
                  <div className="choose-box w-100 mt-auto">
                    <div onClick={openChoosePaymentModal}
                      ...
                      {/* <div className="flex select-icon 666"><i className="icon-arrow-right tw-text-3"></i></div> */}
                    </div>
                  </div>
                </div>
              </div>
              <div className="choose-code-wrapper">
                <div className="c--checkout_choose-box choose-box-wrapper flex flex-column h-100">
                  <div className="choose-box-header w-100 mb-20">
                    <h2>
                      Apply Code or Use Esimoney
                    </h2>
                    <p>
                      You can apply your discount / referral code or use Esimoney upon purchase.
                    </p>
                  </div>
                  <div className="choose-box w-100 mt-auto" onClick={openApplyCodeModal}>
                    <div 
                      className="choose-box-inner relative flex justify-content-between align-items-center cursor-pointer">
                      <p data-testid="Apply Code / Use Emoney-payment-option" className="select">Apply
                        Code / Use Esimoney</p>
                        <ArrowForwardIosIcon fontSize="small" className="ml-10" />
                    </div>
                  </div>
                ...
                <div className="order-summary-mobile-inner">
                  <div id="" className="collapse show">
                    <div className="d-grid grid-cols-2 gap-20 px-20 py-20">
                      <div
                        className="order-summary-mobile-info flex flex-column align-items-start justify-content-center">
                    ...
                    <div className="order-summary-mobile-list">
                      <div className="order-summary-mobile-list-header px-20 pb-20"><button type="button"
                          ...
                          style={{overflowAnchor: 'none'}}><span
                            className="c--shared_icons icon-wrapper flex"><img
          ...
          <div className=" d-sm-flex">
            <div className="d-grid grid-cols-md-12 grid-cols-lg-12 w-100">
              <div
                className="flex flex-column justify-content-center align-items-center pay-button-wrapper pay-button-general">
